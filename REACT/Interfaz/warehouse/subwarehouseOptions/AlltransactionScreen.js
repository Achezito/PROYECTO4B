  ...
  useEffect(() => {
    ...
    const filtered = transactions.filter((item) => {
      ...
      const fechaTransaccion =
        item["Fecha de Transaccion"]?.toLowerCase() || "";
          ...
          renderItem={({ item }) => (
            <View style={styles.card}>
              <Text style={styles.cardTitle}>
                ID Transacción: {item["ID Transaccion"]}
              </Text>
              <Text style={styles.cardText}>
                Fecha: {item["Fecha de Transaccion"]}
              </Text>
              <Text style={styles.cardText}>
                Tipo: {item["Tipo de Transaccion"]}
              </Text>
              <Text style={styles.cardText}>Cantidad: {item["Cantidad"]}</Text>
              <Text style={styles.cardText}>
                Ubicación: {item["Almacen de destino"]}
              </Text>
              <Text style={styles.cardText}>Material: {item["Material"]}</Text>
              <Text style={styles.cardText}>
                Descripción: {item["Descripcion del Material"]}
              </Text>
            </View>
          )}
        />
